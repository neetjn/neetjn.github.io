...
<div class="w-full h-screen bg-red-400 text-center text-white animated fadeIn">
  ...
  <div class="relative w-full h-screen table z-20">
    <div class="table-cell align-middle">
      ...
      <h1 class="text-lg md:text-2xl mb-8 font-semibold uppercase">
        I'm a full stack software engineer.
      </h1>
      <button class="hidden md:inline-block text-xl font-bold uppercase p-4 border-4 border-red-500 hover:border-red-400 hover:underline hover:text-red-500 transition transition-color">
